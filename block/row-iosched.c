...
SHOW_FUNCTION(row_read_idle_show, rowd->read_idle.idle_time);
SHOW_FUNCTION(row_read_idle_freq_show, rowd->read_idle.freq);
#undef SHOW_FUNCTION
...
STORE_FUNCTION(row_lp_swrite_quantum_store,
			&rowd->row_queues[ROWQ_PRIO_LOW_SWRITE].disp_quantum,
			1, INT_MAX);
STORE_FUNCTION(row_read_idle_store, &rowd->read_idle.idle_time, 1, INT_MAX);
STORE_FUNCTION(row_read_idle_freq_store, &rowd->read_idle.freq, 1, INT_MAX);
