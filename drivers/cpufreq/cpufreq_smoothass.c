 ...
 */
#define DEFAULT_UP_MIN_FREQ 864000
 ...
 */
#define DEFAULT_RAMP_UP_STEP 594000
...
static void cpufreq_smoothass_freq_change_time_work(struct work_struct *work)
{
	...
	this_smoothass = &per_cpu(smoothass_info, 0);
		...
		unsigned int event)
{
	...
	case CPUFREQ_GOV_START:
		...
		this_smoothass->cur_policy->max = 1512000;
		this_smoothass->cur_policy->min = 384000;
		this_smoothass->cur_policy->cur = 1512000;
