...
enum ioctl_command_no {
	...
	IOCTL_TS_START 			= 0x1101,	/* TS Output : Serial TS Output Star		*/
...
#define		PARAM_LAYERSEL_C		0x02	/* C Layer					*/
							...
							/* IQINV					*/
#define		PARAM_IQINV_IQINV_NORM		0x00	/* not Inver					*/
...
#define		PARAM_TUNER_IRQ_CHEND		0x01	/* Channel End Interrup				*/
